...
DELIVERY_PLATFORM_GOOGLE_CLOUD_STORAGE = DATA_SOURCE_PLATFORM_GOOGLE_CLOUD_STORAGE
...
CLIENT_PROJECT_FIELD_NAME = "name"
CLIENT_PROJECT_FIELD_TYPE = "type"
CLIENT_PROJECT_FIELD_DESCRIPTION = "description"
CLIENT_PROJECT_FIELD_URL = "url"
CLIENT_PROJECT_FIELD_ICON = "icon"
CLIENT_PROJECT_FIELD_ACCESS_LEVEL = "access_level"
...
ALLOWED_FIELDS = {
    ...
    CLIENT_PROJECTS_COLLECTION: [
        NAME,
        TYPE,
        CLIENT_PROJECT_FIELD_DESCRIPTION,
        URL,
        CLIENT_PROJECT_FIELD_ICON,
        CLIENT_PROJECT_FIELD_ACCESS_LEVEL,
    ],
}
