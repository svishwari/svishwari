...
[![codecov](https://codecov.test.huxstg.in/gh/DeloitteHux/hux-unified/branch/develop/graph/badge.svg?token=3TFILM9QX3)](https://codecov.test.huxstg.in/gh/DeloitteHux/hux-unified)
...
Argo CD|[https://argocd.hux-unified-dev1.in/](https://argocd.hux-unified-dev1.in/)|[https://argocd.main.use1.hux-unified-stg1.in/](https://argocd.main.use1.hux-unified-stg1.in/)|[https://argocd.main.use1.hux-unified-rc1.in/](https://argocd.main.use1.hux-unified-rc1.in/)| - |
...
## Azure Environments
Component| HUSDEV2                                                                                                              | LILDEV | LPZDEV                                                                                                                  |
---------|----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|
Hux Unified UI| [https://unified-ui-dev.main.use2.hux-husdev2.in/](https://unified-ui-dev.main.use2.hux-husdev2.in/)                 |[https://unified-ui-dev.main.use2.hux-lildev.in/](https://unified-ui-dev.main.use2.hux-lildev.in/)                       | https://unified-ui-dev.main.use2.dev.hux.lillypulitzer.com/
Hux Unified API| [https://unified-api-dev.main.use2.hux-husdev2.in/api/v1/ui/](https://unified-api-dev.main.use2.hux-husdev2.in/api/v1/ui/) | [https://unified-api-dev.main.use2.hux-lildev.in/api/v1/ui/](https://unified-api-dev.main.use2.hux-lildev.in/api/v1/ui/) | https://unified-api-lpzdev.main.use2.dev.hux.lillypulitzer.com/api/v1/ui/
Argo CD| [https://argocd.hux-husdev2.in/](https://argocd.hux-husdev2.in/)                                                     | [https://argocd-uni.hux-lildev.in/](https://argocd-uni.hux-lildev.in/)                                                   |
