...
class OrchestrationRouteTest(RouteTestCase):
        ...
        audiences = [
            {
                ...
                db_c.SIZE: 3329,
                "audience_tags": {api_c.INDUSTRY: ["healthcare", "retail"]},
            },
            {
                ...
                api_c.USER_NAME: self.user_name,
                "audience_tags": {api_c.INDUSTRY: ["hospitality"]},
            },
        ]
    ...
    def test_create_audience_with_destination(self):
        ...
        self.assertEqual(response.json[db_c.TAGS], {db_c.INDUSTRY: ["healthcare"]})
    ...
    def test_update_audience(self):
        ...
        self.assertEqual(
            self.audiences[0][api_c.TAGS], {api_c.INDUSTRY: ["healthcare", "retail"]}
        )
        ...
        self.assertIn(api_c.TAGS, response.json)
        self.assertEqual(response.json[api_c.TAGS], {api_c.INDUSTRY: ["hospitality"]})
    ...
    def test_get_audiences_with_valid_filters(self):
        ...
        response = self.app.get(
            ...
            f"{api_c.INDUSTRY_TAG}=healthcare",
            headers=t_c.STANDARD_HEADERS,
        )
        ...
        self.assertIn("healthcare", audiences[0][api_c.TAGS][api_c.INDUSTRY])
        self.assertIn(api_c.TAGS, audiences[1])
        self.assertIn("healthcare", audiences[1][api_c.TAGS][api_c.INDUSTRY])
    ...
    def test_edit_lookalike_audience(self):
        ...
        self.assertEqual(
            ...
            {api_c.INDUSTRY: ["healthcare", "retail"]},
        )
