...
class CustomersLTV(SwaggerView):
    ...
    responses = {
        HTTPStatus.OK.value: {
            ...
            "description": "Customers Lifetime Value.",
        },
        HTTPStatus.BAD_REQUEST.value: {
            "description": "Failed to get customers lifetime value."
        },
    }
    responses.update(AUTH401_RESPONSE)
    responses.update(FAILED_DEPENDENCY_424_RESPONSE)
    ...
    def get(self) -> Tuple[list, int]:
        ...
        Returns:
            Tuple[list, int]: list of densities, HTTP status code.
        """
...
class CustomersPropensityToPurchase(SwaggerView):
    ...
    responses = {
        HTTPStatus.OK.value: {
            ...
            "description": "Customers Propensity To Purchase Density.",
        },
        HTTPStatus.BAD_REQUEST.value: {
            "description": "Failed to get customers propensity to purchase values."
        },
    }
    responses.update(AUTH401_RESPONSE)
    responses.update(FAILED_DEPENDENCY_424_RESPONSE)
    ...
    def get(self) -> Tuple[list, int]:
        """Retrieves customer propensity to purchase values.
...
class CustomersPropensityToUnsubscribe(SwaggerView):
    """Customers Propensity To Unsubscribe"""
    ...
    responses = {
        HTTPStatus.OK.value: {
            ...
            "description": "Customers propensity To unsubscribe Density.",
        },
        HTTPStatus.BAD_REQUEST.value: {
            "description": "Failed to get customers propensity to unsubscribe values."
        },
    }
    responses.update(AUTH401_RESPONSE)
    responses.update(FAILED_DEPENDENCY_424_RESPONSE)
    ...
    def get(self) -> Tuple[list, int]:
        """Retrieves customer propensity to unsubscribe values.
