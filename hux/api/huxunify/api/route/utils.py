...
def create_description_for_user_request(
    ...
    requested_by: str,
    project_name: str = config(api_c.DEFAULT_NEW_USER_PROJECT_NAME),
    okta_group_name: str = config(api_c.DEFAULT_OKTA_GROUP_NAME),
    okta_app: str = config(api_c.DEFAULT_OKTA_APP),
) -> str:
