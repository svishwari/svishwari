...
SUPPORTED_MODELS = {
    2: {
        ...
        FEATURE_IMPORTANCE: {
            ...
            DESCRIPTION: [
                "Description for 8to12m-ITEMEXTPRICE-sum",
                "Description for 8to12m-ITEMEXTCOST-sum",
                "Description for fwbk_2m-STORENAME-Woolen Mill Store",
                "Description for fwbk_2m-ITEMEXTPRICE-sum",
                "Description for 8to12m-ORDTDOL-sum",
                "Description for fwbk_1to2y-ORDTDOL-max",
                "Description for prediction-months-2",
                "Description for dow-pe_u_dow-pe_count",
                "Description for fwbk_1to2y-ITEMEXTCOST-sum",
                "Description for fwbk_2w-STORENAME-Woolen Mill Store",
                "Description for fwbk_4m-ORDTDOL-sum",
                "Description for 8to12m-COGS-cnt",
                "Description for 8to12m-ITEMEXTPRICE-cnt",
                "Description for fwbk_1to2y-ORDTDOL-sum",
                "Description for 2w-ITEMEXTCOST-sum",
                "Description for profile-data_source-buyers",
                "Description for 8to12m-positive-order",
                "Description for 4w-ITEMQTY-sum",
                "Description for 8to12m-COGS-sum",
                "Description for 4m-ORDITEMQTY-sum",
            ],
        },
    },
    1: {
        ...
        FEATURE_IMPORTANCE: {
            ...
            DESCRIPTION: [
                "Description for 1to2y-COGS-sum",
                "Description for 1to2y-ITEMEXTPRICE-cnt",
                "Description for 1to2y-ITEMQTY-avg",
                "Description for 2m-ORDTDOL-cnt",
                "Description for 2m-COGS-cnt",
                "Description for dow-pe_u_dow-pe_count",
                "Description for 4m-ORDITEMQTY-cnt",
                "Description for duration_days-item-min",
                "Description for 1to2y-ITEMPRICE-min",
                "Description for 2w-ORDITEMQTY-cnt",
                "Description for 2m-ORDITEMQTY-cnt",
                "Description for 4m-ORDTDOL-cnt",
                "Description for dow-u_wd-weekday",
                "Description for 2w-ITEMEXTPRICE-cnt",
                "Description for 4m-ITEMNO-30150",
                "Description for 3d-ITEMPRICE-avg",
                "Description for profile-data_source-buyers",
                "Description for 3d-ITEMEXTPRICE-min",
                "Description for 1to2y-ITEMPRICE-avg",
                "Description for 8to12m-ORDAMT-sum",
            ],
        },
    },
    3: {
