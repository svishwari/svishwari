...
# DESTINATION SECRETS FOR STORING IN PARAM STORE
# IF NOT LISTED HERE IT WILL BE STORED IN THE DESTINATION OBJECT
DESTINATION_SECRETS = {
    db_c.DELIVERY_PLATFORM_FACEBOOK: [
        FACEBOOK_APP_SECRET,
        FACEBOOK_APP_SECRET,
    ],
    db_c.DELIVERY_PLATFORM_SFMC: [SFMC_CLIENT_SECRET],
}
