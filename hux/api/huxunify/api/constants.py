...
CDP_DATA_SOURCE_CATEGORY_MAP = {
    ...
    db_c.DATA_SOURCE_PLATFORM_GOOGLE_ANALYTICS: db_c.CATEGORY_CUSTOMER_SERVICE,
    db_c.DATA_SOURCE_PLATFORM_HTTP: db_c.CATEGORY_CUSTOMER_SERVICE,
    db_c.DATA_SOURCE_PLATFORM_BING: db_c.CATEGORY_CUSTOMER_SERVICE,
