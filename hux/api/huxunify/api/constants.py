...
MODEL_ONE_SHAP_DATA = ["dow-pe_u_dow-count", "duration_days-order-min", "dow-u_wd-weekday", "dow-pe_u_wd-weekday", "1to2y-quantity-cnt", "1to2y-data_source-transactions", "1to2y-price-max", "1to2y-price-sum", "1to2y-price-avg", "1to2y-price-cnt", "1to2y-positive-order", "1to2y-type-transaction", "1to2y-quantity-max", "1to2y-quantity-sum", "1to2y-quantity-avg", "dow-pe_u_dow-thursday", "dow-u_dow-thursday", "8to12m-data_source-transactions", "8to12m-price-max", "8to12m-price-sum"]
MODEL_TWO_SHAP_DATA = ['8to12m-price-min', '8to12m-price-avg', '8to12m-price-cnt', '8to12m-type-transaction', '8to12m-positive-order', '8to12m-quantity-max', '8to12m-quantity-sum', '8to12m-quantity-avg', 'dow-pe_u_dow-tuesday', 'dow-u_dow-tuesday', '1to2y-description-red', 'dow-u_dow-wednesday', 'dow-pe_u_dow-wednesday', '4m-quantity-cnt', '4m-price-avg', '4m-price-sum', '4m-price-max', '4m-price-cnt', '4m-price-min', '1to2y-description-set']
MODEL_ID_PARAMS = [
    {
        "name": MODEL_ID,
