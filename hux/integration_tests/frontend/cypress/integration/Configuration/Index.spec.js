...
describe("View configuration", () => {
  ...
  it("should be able to view configuration screen", () => {
    ...
    cy.get(selector.configuration.teamMemberDrawer.firstName).eq(0).type("Sarah")
    cy.get(selector.configuration.teamMemberDrawer.lastName).eq(0).type("Huxley")
    cy.get(selector.configuration.teamMemberDrawer.email).eq(0).type("Huxley@gmail.com")
    ...
    cy.get(selector.configuration.teamMemberDrawer.requestText).eq(0).type("New team member")
