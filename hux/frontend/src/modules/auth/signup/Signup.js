    ...
    <div>
      <div className="col-sm-12 col-md-7 col-xl-7 col-lg-7">
        <div className="signup-form">
          ...
          <div>
            <h1>
              Elevate your <span className="human-bolded">human</span>{" "}
              experience
            </h1>
          </div>
          <div className="pb-4">
            <h5>
              Create a HUX account as your first step to reinventing your
          ...
          <div>
            <form onSubmit={handleSubmit} className="pb-4">
              ...
              <div
                className={isLengthSufficient ? "text-success" : "text-muted"}
              >
                At least 8 characters—the more characters, the better!
              </div>
              <div
                className={containsLowerCase ? "text-success" : "text-muted"}
              >
                A least 1 lower case letter (a,b,c...)
              </div>
              <div
                className={containsUpperCase ? "text-success" : "text-muted"}
              >
