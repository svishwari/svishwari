...
def get_aws_client(client='s3', aws_access_key=AWS_ACCESS_KEY_ID,
                   aws_secret_key=AWS_SECRET_ACCESS_KEY, region_name=AWS_REGION):
    """
    ...
    :return: aws client
    """
    return boto3.client(client, aws_access_key_id=aws_access_key,
